...
(0, test_1.test)('Garoon Time Attendance - Edge (Headed)', async ({ page }) => {
    ...
    // ===== GO TO FORM =====
    await page.goto('https://grn.mat.co.th/scripts/cbgrn/grn.exe/workflow/send_form?cid=630&fid=2411', { waitUntil: 'networkidle' });
    // ===== LOAD ICS =====
    const records = (0, ics_reader_1.readICS)('./data/schedule.ics');
    // ===== FILL FORM =====
